...
moses_install()
{
	...
	./bjam --with-boost=$wdirect/boost_1_55_0 --with-giza-pp=$wdirect/bin -j4 &> /dev/null || error
...
moses2_install()
{
	...
	./bjam --with-giza-pp=$HOME/bin -j4 --with-xmlrpc-c=$wdirect/xmlrpc -j4  &> /dev/null || error
	./bjam --with-boost=$wdirect/boost_1_55_0 --with-giza-pp=$wdirect/bin --with-xmlrpc-c=$wdirect/xmlrpc --with-srilm=$wdirect/srilm -j4 || error || error
