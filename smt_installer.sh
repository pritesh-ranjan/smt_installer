...
{
	spinner &
	wget --no-check-certificate 'https://doc-0g-7s-docs.googleusercontent.com/docs/securesc/ha0ro937gcuc7l7deffksulhg5h7mbp1/5jok9pveam9q2pfstuno6h4g2u0643k7/1510725600000/03823376703766152229/*/1lciYqL5K2Qu6iIlO4s1Ufylj41wPVN36?e=download' -O srilm.zip	unzip srilm.zip
	cd srilm-1.7.2
	make || error
	make World || error
	kill "$!"
